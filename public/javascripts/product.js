...
<a href="#!" class="btn btn-info btn-sm updateimage"  id="${item.id}"><i class="feather icon-edit"></i>&nbsp;Main Image </a>
<a href="/purchase-product/view-images?id=${item.id}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i>&nbsp;Edit Image </a>
